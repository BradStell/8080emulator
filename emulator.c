...
int main(int argc, char** argv)
{
    ...
    ReadFileIntoMemoryAt(state, "./ROMs/SpaceInvaders/invaders.h", 0);
	ReadFileIntoMemoryAt(state, "./ROMs/SpaceInvaders/invaders.g", 0x800);
	ReadFileIntoMemoryAt(state, "./ROMs/SpaceInvaders/invaders.f", 0x1000);
	ReadFileIntoMemoryAt(state, "./ROMs/SpaceInvaders/invaders.e", 0x1800);
